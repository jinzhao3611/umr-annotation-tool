known_relations = {
    ...
    ':actor-of': {'type': 'participant', 'repeat': False},
    ':affectee': {'type': 'participant', 'repeat': False},
    ':affectee-of': {'type': 'participant', 'repeat': False},
    ':age': {'type': 'modifier', 'repeat': False},
    ':age-of': {'type': 'modifier', 'repeat': False},
    ':apprehensive': {'type': 'modifier', 'repeat': False},
    ':apprehensive-of': {'type': 'modifier', 'repeat': False},
    ':ARG0': {'type': 'participant', 'repeat': False},
    ':ARG0-of': {'type': 'participant', 'repeat': False},
    ':ARG1': {'type': 'participant', 'repeat': False},
    ':ARG1-of': {'type': 'participant', 'repeat': False},
    ':ARG2': {'type': 'participant', 'repeat': False},
    ':ARG2-of': {'type': 'participant', 'repeat': False},
    ':ARG3': {'type': 'participant', 'repeat': False},
    ':ARG3-of': {'type': 'participant', 'repeat': False},
    ':ARG4': {'type': 'participant', 'repeat': False},
    ':ARG4-of': {'type': 'participant', 'repeat': False},
    ':ARG5': {'type': 'participant', 'repeat': False},
    ':ARG5-of': {'type': 'participant', 'repeat': False},
    ':ARG6': {'type': 'participant', 'repeat': False},
    ':ARG6-of': {'type': 'participant', 'repeat': False},
    ':ARG7': {'type': 'participant', 'repeat': False},
    ':ARG7-of': {'type': 'participant', 'repeat': False},
    ':ARG8': {'type': 'participant', 'repeat': False},
    ':ARG8-of': {'type': 'participant', 'repeat': False},
    ':ARG9': {'type': 'participant', 'repeat': False},
    ':ARG9-of': {'type': 'participant', 'repeat': False},
    ':ARG10': {'type': 'participant', 'repeat': False},
    ':ARG10-of': {'type': 'participant', 'repeat': False},
    ':ARG11': {'type': 'participant', 'repeat': False},
    ':ARG11-of': {'type': 'participant', 'repeat': False},
    ':ARG12': {'type': 'participant', 'repeat': False},
    ':ARG12-of': {'type': 'participant', 'repeat': False},
    ...
    ':aspect-of': {'type': 'attribute', 'repeat': False, 'values': ['habitual', 'generic', 'iterative', 'inceptive', 'imperfective', 'process', 'atelic-process', 'perfective', 'state', 'reversible-state', 'irreversible-state', 'inherent-state', 'point-state', 'activity', 'undirected-activity', 'directed-activity', 'endeavor', 'semelfactive', 'undirected-endeavor', 'directed-endeavor', 'performance', 'incremental-accomplishment', 'nonincremental-accomplishment', 'directed-achievement', 'reversible-directed-achievement', 'irreversible-directed-achievement']},
    ':beneficiary': {'type': 'participant', 'repeat': False}, #todo: affecttee
    ':beneficiary-of': {'type': 'participant', 'repeat': False},
    ':calendar': {'type': 'modifier', 'repeat': False},
    ':calendar-of': {'type': 'modifier', 'repeat': False},
    ':cause': {'type': 'modifier', 'repeat': True},
    ':cause-of': {'type': 'modifier', 'repeat': True},
    ':causer': {'type': 'participant', 'repeat': False},
    ':causer-of': {'type': 'participant', 'repeat': False},
    ':century': {'type': 'modifier', 'repeat': False},
    ':century-of': {'type': 'modifier', 'repeat': False},
    ':companion': {'type': 'participant', 'repeat': False},
    ':companion-of': {'type': 'participant', 'repeat': False},
    ':concession': {'type': 'modifier', 'repeat': True},
    ':concession-of': {'type': 'modifier', 'repeat': True},
    ':condition': {'type': 'modifier', 'repeat': True},
    ':condition-of': {'type': 'modifier', 'repeat': True},
    ':consist-of': {'type': 'modifier', 'repeat': False}, #todo:? split into other roles(have-group-91, have-material-91)
    ':consist-of-of': {'type': 'modifier', 'repeat': False},
    ':day': {'type': 'attribute', 'repeat': False},
    ':day-of': {'type': 'attribute', 'repeat': False},
    ':dayperiod': {'type': 'attribute', 'repeat': False},
    ':dayperiod-of': {'type': 'attribute', 'repeat': False},
    ':decade': {'type': 'modifier', 'repeat': False},
    ':decade-of': {'type': 'modifier', 'repeat': False},
    ':degree': {'type': 'attribute', 'repeat': False, 'value': ['intensifier', 'downtoner', 'equal']},
    ':degree-of': {'type': 'attribute', 'repeat': False, 'value': ['intensifier', 'downtoner', 'equal']},
    ':destination': {'type': 'modifier', 'repeat': True}, #todo? :goal
    ':destination-of': {'type': 'modifier', 'repeat': True},
    ':direction': {'type': 'modifier', 'repeat': True},
    ':direction-of': {'type': 'modifier', 'repeat': True},
    ':domain': {'type': 'modifier', 'repeat': False}, #todo:? replaced with have-mode, have rel role, exist 91
    ':domain-of': {'type': 'modifier', 'repeat': False},
    ':duration': {'type': 'modifier', 'repeat': True},
    ':duration-of': {'type': 'modifier', 'repeat': True},
    ':era': {'type': 'modifier', 'repeat': False},
    ':era-of': {'type': 'modifier', 'repeat': False},
    ':example': {'type': 'modifier', 'repeat': True},
    ':example-of': {'type': 'modifier', 'repeat': True},
    ':experiencer': {'type': 'participant', 'repeat': False},
    ':experiencer-of': {'type': 'participant', 'repeat': False},
    ':extent': {'type': 'modifier', 'repeat': False},
    ':extent-of': {'type': 'modifier', 'repeat': False},
    ':force': {'type': 'participant', 'repeat': False},
    ':force-of': {'type': 'participant', 'repeat': False},
    ':frequency': {'type': 'modifier', 'repeat': False},
    ':frequency-of': {'type': 'modifier', 'repeat': False},
    ':goal': {'type': 'participant', 'repeat': False},
    ':goal-of': {'type': 'participant', 'repeat': False},
    ':group': {'type': 'modifier', 'repeat': False},
    ':group-of': {'type': 'modifier', 'repeat': False},
    ':instrument': {'type': 'participant', 'repeat': False},
    ':instrument-of': {'type': 'participant', 'repeat': False},
    ':li': {'type': 'modifier', 'repeat': False}, #todo: is this replaced by :list-item
    ':li-of': {'type': 'modifier', 'repeat': False},
    #':location': {'type': 'modifier', 'repeat': True}, # obsolete; use :place instead
    #':location-of': {'type': 'modifier', 'repeat': True},
    ':manner': {'type': 'modifier', 'repeat': True},
    ':manner-of': {'type': 'modifier', 'repeat': True},
    ':material': {'type': 'participant', 'repeat': False},
    ':material-of': {'type': 'participant', 'repeat': False},
    ':medium': {'type': 'modifier', 'repeat': False},
    ':medium-of': {'type': 'modifier', 'repeat': False},
    ...
    ':month-of': {'type': 'attribute', 'repeat': False},
    ':name': {'type': 'modifier', 'repeat': False},
    ':name-of': {'type': 'modifier', 'repeat': False},
    ':op1': {'type': 'attribute', 'repeat': False},
    ':op1-of': {'type': 'attribute', 'repeat': False},
    ':op2': {'type': 'attribute', 'repeat': False},
    ':op2-of': {'type': 'attribute', 'repeat': False},
    ':op3': {'type': 'attribute', 'repeat': False},
    ':op3-of': {'type': 'attribute', 'repeat': False},
    ':op4': {'type': 'attribute', 'repeat': False},
    ':op4-of': {'type': 'attribute', 'repeat': False},
    ':op5': {'type': 'attribute', 'repeat': False},
    ':op5-of': {'type': 'attribute', 'repeat': False},
    ':op6': {'type': 'attribute', 'repeat': False},
    ':op6-of': {'type': 'attribute', 'repeat': False},
    ':op7': {'type': 'attribute', 'repeat': False},
    ':op7-of': {'type': 'attribute', 'repeat': False},
    ':op8': {'type': 'attribute', 'repeat': False},
    ':op8-of': {'type': 'attribute', 'repeat': False},
    ':op9': {'type': 'attribute', 'repeat': False},
    ':op9-of': {'type': 'attribute', 'repeat': False},
    ':op10': {'type': 'attribute', 'repeat': False},
    ':op10-of': {'type': 'attribute', 'repeat': False},
    ':op11': {'type': 'attribute', 'repeat': False},
    ':op11-of': {'type': 'attribute', 'repeat': False},
    ':op12': {'type': 'attribute', 'repeat': False},
    ':op12-of': {'type': 'attribute', 'repeat': False},
    ':ord': {'type': 'modifier', 'repeat': False},
    ':ord-of': {'type': 'modifier', 'repeat': False},
    ':other-role': {'type': 'modifier', 'repeat': True},
    ':other-role-of': {'type': 'modifier', 'repeat': True},
    ':part': {'type': 'modifier', 'repeat': True},
    ':part-of': {'type': 'modifier', 'repeat': True},
    ':path': {'type': 'modifier', 'repeat': True},
    ':path-of': {'type': 'modifier', 'repeat': True},
    ':place': {'type': 'participant', 'repeat': False},
    ':place-of': {'type': 'participant', 'repeat': False},
    ':polarity': {'type': 'attribute', 'repeat': False, 'value':['-', 'umr-unknown', 'truth-value']},
    ':polarity-of': {'type': 'attribute', 'repeat': False, 'value':['-', 'umr-unknown', 'truth-value']},
    ':polite': {'type': 'attribute', 'repeat': False, 'values':['+']}, #todo:?
    ':polite-of': {'type': 'attribute', 'repeat': False, 'values':['+']},
    ...
    ':possessor-of': {'type': 'modifier', 'repeat': True},
    ':purpose': {'type': 'modifier', 'repeat': True},
    ':purpose-of': {'type': 'modifier', 'repeat': True},
    ':quant': {'type': 'attribute', 'repeat': False},
    ':quant-of': {'type': 'attribute', 'repeat': False},
    ':quarter': {'type': 'modifier', 'repeat': False},
    ':quarter-of': {'type': 'modifier', 'repeat': False},
    ...
    ':quote-of': {'type': 'modifier', 'repeat': True},
    ...
    ':scale-of': {'type': 'modifier', 'repeat': False},
    ':source': {'type': 'participant', 'repeat': False},
    ':source-of': {'type': 'participant', 'repeat': False},
    ':start': {'type': 'participant', 'repeat': False},
    ':start-of': {'type': 'participant', 'repeat': False},
    ':stimulus': {'type': 'participant', 'repeat': False},
    ':stimulus-of': {'type': 'participant', 'repeat': False},
    ':subevent': {'type': 'modifier', 'repeat': False},
    ':subevent-of': {'type': 'modifier', 'repeat': False},
    ':substitute': {'type': 'modifier', 'repeat': False},
    ':substitute-of': {'type': 'modifier', 'repeat': False},
    ':subtraction': {'type': 'modifier', 'repeat': False},
    ':subtraction-of': {'type': 'modifier', 'repeat': False},
    ':temporal': {'type': 'modifier', 'repeat': True},
    ':temporal-of': {'type': 'modifier', 'repeat': True},
    ':theme': {'type': 'participant', 'repeat': False},
    ':theme-of': {'type': 'participant', 'repeat': False},
    ':time': {'type': 'attribute', 'repeat': True},
    ':time-of': {'type': 'attribute', 'repeat': True},
    ':timezone': {'type': 'modifier', 'repeat': False},
    ':timezone-of': {'type': 'modifier', 'repeat': False},
    ':topic': {'type': 'modifier', 'repeat': False},
    ':topic-of': {'type': 'modifier', 'repeat': False},
    ':undergoer': {'type': 'participant', 'repeat': False},
    ':undergoer-of': {'type': 'participant', 'repeat': False},
    ':unit': {'type': 'attribute', 'repeat': False},
    ':unit-of': {'type': 'attribute', 'repeat': False},
    ':value': {'type': 'attribute', 'repeat': False},
    ':value-of': {'type': 'attribute', 'repeat': False},
    ':vocative': {'type': 'modifier', 'repeat': False},
    ':vocative-of': {'type': 'modifier', 'repeat': False},
    ':weekday': {'type': 'modifier', 'repeat': False},
    ':weekday-of': {'type': 'modifier', 'repeat': False},
    ':wiki': {'type': 'attribute', 'repeat': False},
    ':wiki-of': {'type': 'attribute', 'repeat': False},
    ':year': {'type': 'attribute', 'repeat': False},
    ':year-of': {'type': 'attribute', 'repeat': False},
    ':year2': {'type': 'attribute', 'repeat': False},
    ':year2-of': {'type': 'attribute', 'repeat': False},
    ...
    ':according-to-of': {'type': 'modifier', 'repeat': False},
    ':axis-relative-polarities': {'type': 'attribute', 'repeat': False, 'values':['left-handed', 'right-handed']},
    ':axis-relative-polarities-of': {'type': 'attribute', 'repeat': False, 'values':['left-handed', 'right-handed']},
    ':framework-type':{'type':'attribute', 'repeat':False, 'values':['absolute', 'intrinsic','relative']},
    ':framework-type-of':{'type':'attribute', 'repeat':False, 'values':['absolute', 'intrinsic','relative']},
    ':anchor-framework-translation': {'type': 'attribute', 'repeat': False, 'values': ['rotated', 'reflected']},
    ':anchor-framework-translation-of': {'type': 'attribute', 'repeat': False, 'values': ['rotated', 'reflected']},
    ':co-actor': {'type': 'modifier', 'repeat': False},
    ':co-actor-of': {'type': 'modifier', 'repeat': False},
    ':axis': {'type': 'modifier', 'repeat': False},
    ':axis-of': {'type': 'modifier', 'repeat': False},
    ':anchor': {'type': 'modifier', 'repeat': False},
    ':anchor-of': {'type': 'modifier', 'repeat': False},
    ':color': {'type': 'modifier', 'repeat': False},
    ':color-of': {'type': 'modifier', 'repeat': False},
    ':concessive-condition': {'type': 'modifier', 'repeat': False},
    ':concessive-condition-of': {'type': 'modifier', 'repeat': False},
    ':role': {'type': 'modifier', 'repeat': False},
    ':role-of': {'type': 'modifier', 'repeat': False},
    ':identity': {'type': 'modifier', 'repeat': False},
    ':identity-of': {'type': 'modifier', 'repeat': False},
    ':orientation': {'type': 'modifier', 'repeat': False},
    ':orientation-of': {'type': 'modifier', 'repeat': False},
    ':result': {'type': 'modifier', 'repeat': False},
    ':result-of': {'type': 'modifier', 'repeat': False},
    ':size': {'type': 'modifier', 'repeat': False},
    ':size-of': {'type': 'modifier', 'repeat': False},
    ':list-item': {'type': 'modifier', 'repeat': False},
    ':list-item-of': {'type': 'modifier', 'repeat': False},
    ':configuration': {'type': 'modifier', 'repeat': False},
    ':configuration-of': {'type': 'modifier', 'repeat': False},
    ':pure-addition': {'type': 'modifier', 'repeat': False},
    ':pure-addition-of': {'type': 'modifier', 'repeat': False}
}
