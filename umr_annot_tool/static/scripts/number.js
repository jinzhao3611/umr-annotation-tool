...
(data, options={}) => {
  ...
  ${tangleLayout.nodes.map(
      n => {
        console.log(n.id); 
        let s = '';
        if(!['(non-trial Paucal)', 'Number'].includes(n.id)){
...
[
  [{ id: 'Number' }],
  [{ id: 'Singular', parents: ['Number'] }, { id: 'Non-singular', parents: ['Number'] }],
  [
    { id: 'Paucal', parents: ['Non-singular'] },
    { id: 'Plural', parents: ['Non-singular'] }
  ],
  [
    { id: 'Dual', parents: ['Paucal'] },
    { id: 'Non-dual Paucal', parents: ['Paucal','Plural'] },
    { id: '(non-trial Paucal)', parents: ['Plural'] }, //dummy token
    { id: 'Greater Plural', parents: ['Plural'] },
  ],
  [
    { id: 'Trial', parents: ['Non-dual Paucal'] },
    { id: 'Non-trial Paucal', parents: ['Non-dual Paucal', '(non-trial Paucal)'] },
  ],
]
)});
