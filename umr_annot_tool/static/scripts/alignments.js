        ...
        html += `
            <div class="alignment-item" data-variable="${variable}">
                <div class="d-flex align-items-center mb-2">
                    <span class="variable badge bg-primary" onclick="makeEditable(this, '${variable}')">${variable}</span>
                </div>
                <div class="alignments-list">
                    ${alignments.map(alignment => `
                        <div class="alignment-item d-flex justify-content-between align-items-center mb-1">
                            <span class="alignment badge bg-secondary me-1" onclick="makeEditable(this, '${variable}', '${alignment}')">${alignment}</span>
                            <button class="btn btn-sm btn-outline-danger" onclick="deleteAlignmentValue('${variable}', '${alignment}')">
