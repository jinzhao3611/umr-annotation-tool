...
/**
 * load the annotation for current sentence from database, load modal annotation from sentence level
...
function initialCommand(current_snt_id){
        let parentArg = document.getElementById('parentArg').value;// s2h2
