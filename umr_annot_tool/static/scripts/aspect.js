...
[
  [{ id: 'Aspect' }],
  [{ id: 'Habitual', parents: ['Aspect'] }, { id: 'Imperfective', parents: ['Aspect'] }, { id: 'Process', parents: ['Aspect'] }],
  [
    { id: 'Atelic Process', parents: ['Imperfective', 'Process'] },
    { id: 'Perfective', parents: ['Process'] }
  ],
  [
    { id: 'State', parents: ['Imperfective'] },
    { id: 'Activity', parents: ['Atelic Process'] },
    { id: 'Endeavor', parents: ['Atelic Process', 'Perfective'] },
    { id: 'Performance', parents: ['Perfective'] }
  ],
  [
    { id: 'Reversible State', parents: ['State'] },
    { id: 'Irreversible State', parents: ['State'] },
    { id: 'Inherent State', parents: ['State'] },
    { id: 'Point State', parents: ['State'] },
    { id: 'Undirected Activity', parents: ['Activity'] },
    { id: 'Directed Activity', parents: ['Activity'] },
    { id: 'Semelfactive', parents: ['Endeavor'] },
    { id: 'Undirected Endeavor', parents: ['Endeavor'] },
    { id: 'Directed Endeavor', parents: ['Endeavor'] },
    { id: 'Incremental Accomplishment', parents: ['Performance'] },
    { id: 'Nonincremental Accomplishment', parents: ['Performance'] },
    { id: 'Directed Achievement', parents: ['Performance'] },
  ],
  [
    { id: 'Reversible Directed Achievement', parents: ['Directed Achievement'] },
    { id: 'Irreversible Directed Achievement', parents: ['Directed Achievement'] },
  ]
]
)});
