...
function string2umr_recursive(annotText, loc, state, ht) {
    ...
    if (state === 'pre-open-parenthesis') {
        ...
        if (annotText.match(/^\(\s*s[-_a-zA-Z0-9']*(\s*\/\s*|\s+)[a-zA-Z0-9][-_a-zA-Z0-9']*[\s)]/) // match something like (s1s / shadahast) or (s1s / shadahast with a newline at the end
            ...
            if (concept.match(/^[a-zA-Z0-9][-_a-zA-Z0-9']*(?:-\d+)?$/) //match something like quick-01 //todo:does this match default and chinese as well? no
