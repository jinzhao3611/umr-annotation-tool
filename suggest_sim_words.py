                    ...
                    for word2 in words.findall('word'): # each word
                        for child in word2:
                            if child.tag == 'item':
                                ...
                                for morph in child:
                                    for item in morph:
                                        if (morph.attrib['type'] == 'stem' or morph.attrib['type'] =='root') and item.attrib['type'] == 'txt':
                                            root_of_word = item.text
                                        if (morph.attrib['type'] == 'stem' or morph.attrib['type'] =='root') and item.attrib['type'] == 'gls':
...
if __name__ == '__main__':
    ...
    word_candidates = generate_candidate_list(content_string, 'toolbox1')
