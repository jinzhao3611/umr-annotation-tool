...
(data, options={}) => {
  ...
  ${tangleLayout.nodes.map(
      n => {
        console.log(n.id); 
        let s = '';
        if(!['Affirmative Modal Str', 'Negative Modal Str'].includes(n.id)){
        ...
        return s + `
            ...
            <text class="selectable" data-id="${n.id}" x="${n.x + 4}" y="${n.y - n.height / 2 - 4}" stroke="${background_color}" stroke-width="2">${n.id}
            </text>
...
[
  [{ id: 'Affirmative Modal Str' },
  { id: 'Negative Modal Str' } ],
  [{ id: 'Non-NeutAff', parents: ['Affirmative Modal Str'] },
    { id: 'Non-FullAff', parents: ['Affirmative Modal Str'] },
    { id: 'Non-NeutNeg', parents: ['Negative Modal Str'] },
    { id: 'Non-FullNeg', parents: ['Negative Modal Str'] }],
  [
    { id: 'FullAff', parents: ['Non-NeutAff'] },
    { id: 'PrtAff', parents: ['Non-NeutAff', 'Non-FullAff'] },
    { id: 'NeutAff', parents: ['Non-FullAff'] },
    { id: 'FullNeg', parents: ['Non-NeutNeg'] },
    { id: 'PrtNeg', parents: ['Non-NeutNeg', 'Non-FullNeg'] },
    { id: 'NeutNeg', parents: ['Non-FullNeg']}

  ],
  [
    { id: 'Strong-PrtAff', parents: ['PrtAff'] },
    { id: 'Weak-PrtAff', parents: ['PrtAff'] },
    { id: 'Strong-NeutAff', parents: ['NeutAff'] },
    { id: 'Weak-NeutAff', parents: ['NeutAff'] },
    { id: 'Strong-PrtNeg', parents: ['PrtNeg'] },
    { id: 'Weak-PrtNeg', parents: ['PrtNeg'] },
    { id: 'Strong-NeutNeg', parents: ['NeutNeg'] },
    { id: 'Weak-NeutNeg', parents: ['NeutNeg'] },
  ]
]
)});
